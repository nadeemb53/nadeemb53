...
Protocol engineer at [Consensys](https://consensys.io). I work on Ethereum layer 2 infrastructure, mostly sequencers, consensus clients and validators.

Rust and Kotlin day to day. Solidity, Go and TypeScript when the job needs them.

### Currently

- **[Lineth](https://github.com/LFDT-Lineth/lineth-monorepo)**, an enterprise EVM layer 2 framework and an [LFDT](https://www.lfdecentralizedtrust.org/) project. I work on sequencer internals, the Maru consensus client and Linea Besu plugins.
- **[Status Network](https://github.com/Linea-Consortium/status-network-monorepo)**, a rollup built on the Linea stack.
...
[x.com/0xnadeem](https://x.com/0xnadeem) · [nadeemb53@gmail.com](mailto:nadeemb53@gmail.com)
